...
router.get('/:id', function(req, res, next) {
  knex('organizations')
    ...
    .join('user_flowers', 'organization_members.user_id', '=', 'user_flowers.reciever_user_id')
...
router.get('/:id/flowers', function(req, res, next) {
  ...
  knex('user_flowers as uf')
    ...
    .join('organization_members', 'uf.reciever_user_id', '=', 'organization_members.user_id')
    .join('organizations', 'organization_members.organization_id', '=', 'organizations.id')
    .select('uf.id', 'flowers.name as flower_name', 'uf.message', 'uf.created_at as recieved_at')
